  ...
  <div class="login-container">
    <div class="login-box">
      <div style="text-align: center;">
        <img src="@/assets/imgs/taopp.png" alt="" style="width: 25%; height: auto; margin-bottom: 20px;">
        <div style="font-weight: bold; font-size: 24px; margin-bottom: 30px; color: #7e0928;">欢迎登录电影购票系统</div>
      </div>
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" v-model="data.form.role" blaceholder="请选择角色">
...
.login-container {
  ...
  align-items: center;
  background: linear-gradient(to top, #fcfcfc, #fcfcfc, #fcfcfc);
}
.login-box {
  width: 400px;
  padding: 50px;
